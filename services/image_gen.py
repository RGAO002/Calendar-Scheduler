...
def _get_font(size: int, bold: bool = False) -> ImageFont.FreeTypeFont:
    ...
    for path in _FONT_PATHS:
        try:
            # Index 0 = regular, some .ttc files have bold at index 1+
...
_STEP_THEMES = [
    {"bg": (99, 102, 241), "text": (255, 255, 255), "bubble": (255, 255, 255, 220), "btxt": (30, 30, 60)},       # indigo
    {"bg": (16, 185, 129), "text": (255, 255, 255), "bubble": (255, 255, 255, 220), "btxt": (10, 60, 40)},       # emerald
    {"bg": (245, 158, 11), "text": (255, 255, 255), "bubble": (255, 255, 255, 220), "btxt": (80, 50, 0)},        # amber
    {"bg": (239, 68, 68),  "text": (255, 255, 255), "bubble": (255, 255, 255, 220), "btxt": (80, 20, 20)},       # red
    {"bg": (139, 92, 246), "text": (255, 255, 255), "bubble": (255, 255, 255, 220), "btxt": (50, 20, 80)},       # purple
    {"bg": (6, 182, 212),  "text": (255, 255, 255), "bubble": (255, 255, 255, 220), "btxt": (10, 50, 60)},       # cyan
]
...
def _draw_rounded_rect(
    ...
    # Use Pillow's built-in rounded_rectangle if available
    try:
...
def _add_infographic(
    ...
    annotations: list of {"text": "...", "position": "top-left"|"top-right"|"bottom-left"|"bottom-right"|"center"}
    ...
    # Banner background — rounded rect with step color
    _draw_rounded_rect(
        draw,
    ...
    # Step badge circle inside banner
    ...
    # Position map: where each annotation goes
    positions = {
        "top-left": (margin, margin + banner_h + 8),
        "top-right": None,  # computed dynamically
        "bottom-left": None,
        "bottom-right": None,
        "center-left": None,
        "center-right": None,
    ...
    # Default position cycle if not specified
...
# ── Gemini step planner (now with annotations) ─────────
...
def _gemini_plan_steps(
    ...
    Returns list of:
    {
      ...
      "scene": "Detailed scene description for Imagen...",
      "annotations": [
        {"text": "Key fact or explanation", "position": "bottom-left"},
        {"text": "Another callout", "position": "bottom-right"}
      ]
    }
    """
...
def generate_concept_images(
    ...
    Pipeline: Gemini plans steps → Imagen generates → Pillow adds infographic overlays.
...
# ── Backward-compat single-image (used by quiz_graph) ──
...
def generate_concept_image(
    ...
    """Generate a single concept illustration. Used by quiz_graph."""
