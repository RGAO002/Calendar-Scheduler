...
from quiz.templates.base import COLOR_SCHEMES, inject_config
...
def build_quiz_html(
    ...
    """
    from quiz.templates.card_flip import render as render_card_flip
    from quiz.templates.classic_test import render as render_classic
    from quiz.templates.progress_quest import render as render_progress
    from quiz.templates.timed_challenge import render as render_timed
